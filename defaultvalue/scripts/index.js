...
// main-lookbook_overtxt
    let lookbook_overtxt = document.querySelector('.lookbook_overtxt')
    let lookbook_img = document.querySelector('.lookbook_img')

    lookbook_overtxt.addEventListener('mouseover',function(){
        lookbook_img.style.filter = 'opacity(80%)'
    })
    lookbook_overtxt.addEventListener('mouseout',function(){
        lookbook_img.style.filter = 'opacity(100%)'
    })
